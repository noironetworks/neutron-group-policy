...
from neutron.services.grouppolicy import group_policy_context as p_context
from neutron.services.grouppolicy import policy_driver_manager as manager
...
class GroupPolicyPlugin(group_policy_mapping_db.GroupPolicyMappingDbPlugin):
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                LOG.error(_(
                    ...
                    "failed, deleting endpoint_group '%s'"), endpoint_group_id)
    ...
    def create_l2_policy(self, context, l2_policy):
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                LOG.error(_(
                    "policy_driver_manager.create_l2_policy_postcommit "
    ...
    def delete_l2_policy(self, context, l2_policy_id):
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                LOG.error(_(
                    "policy_driver_manager.delete_l2_policy_postcommit "
    ...
    def create_l3_policy(self, context, l3_policy):
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                LOG.error(_(
                    "policy_driver_manager.create_l3_policy_postcommit "
    ...
    def delete_l3_policy(self, context, l3_policy_id, check_unused=False):
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                LOG.error(_(
                    "policy_driver_manager.delete_l3_policy_postcommit "
